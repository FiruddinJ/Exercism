...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if (voltage * current)/theoretical_max_power * 100 >= 80:
        return "green"
    elif 80 > (voltage * current)/theoretical_max_power * 100 >= 60:
        return "orange"
    elif 60 > (voltage * current)/theoretical_max_power * 100 >= 30:
        return "red"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < threshold * 0.9:
        ...
        return "NORMAL"
    elif 0 >= temperature * neutrons_produced_per_second >= threshold * 0.1:
        return "NORMAL"
    else:
        return "DANGER"